...
export const publisherFilterColumn = [
  ...
  { label: 'Country', value: 'pub_country', icon: <FiGlobe /> },
  { label: 'Status', value: 'pub_status', icon: <FiAlertCircle /> },
  { label: 'State', value: 'pub_state', icon: <FiMap /> },
  { label: 'Timezone', value: 'pub_timezone', icon: <FiClock /> },
