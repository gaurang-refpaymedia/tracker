...
export const publisherFilterColumn = [
  { label: 'All Filters', value: 'All', icon: <FiEye /> },
  { label: 'Publisher ID', value: 'id', icon: <FiTag /> },
  { label: 'Publisher Code', value: 'pubcode', icon: <FiHash /> },
  { label: 'Country', value: 'pub_country_id', icon: <FiGlobe /> },
  { label: 'Status', value: 'pub_status_id', icon: <FiAlertCircle /> },
  { label: 'State', value: 'pub_state_id', icon: <FiMap /> },
  { label: 'Timezone', value: 'pub_timezone_id', icon: <FiClock /> },
